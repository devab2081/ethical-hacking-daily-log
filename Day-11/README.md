...
I understood that a vulnerability is a weakness, while a threat is something that can exploit that weakness.  
Vulnerability assessment helps organizations understand what needs to be fixed before attackers can misuse it.
...
- Regular assessment improves security  
